...
type DiscountResponse struct {
	...
	ValueInCents float32 `protobuf:"fixed32,4,opt,name=value_in_cents,json=valueInCents,proto3" json:"value_in_cents,omitempty"`
}
...
func (x *DiscountResponse) GetValueInCents() float32 {
	if x != nil {
...
var file_domains_proto_rawDesc = []byte{
	...
	0x74, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0c, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x49,
