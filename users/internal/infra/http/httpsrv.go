...
func (s *httpService) RegisterRoutes() *httpService {
	...
	gV1.POST("/users", s.handleCreateV1)
	gV1.GET("/users", s.handleGetV1)
	gV1.GET("/users/:userId", s.handleGetByIdV1)
	gV1.PATCH("/users/:userId", s.handleUpdateV1)
	gV1.DELETE("/users/:userId", s.handleDeleteV1)
